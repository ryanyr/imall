...
<div class="wrapper">
	...
	<div class="content-wrapper">
		...
		<!-- Main content -->
		<form class="form-inline" role="form" id="queryform" name="queryform" method="post" action="<%=basePath%>review/onLoanReview/list">
			<section class="content">
								...
								<table id="example2" class="table table-bordered table-hover">
									...
									<c:forEach items="${list}" var="order">
										<tr>
											...
											<td><a href="<%=basePath%>review/onLoanReview/loanOrderDetail?orderId=${order.id}">审核</a></td>
										</tr>
									</c:forEach>
									</tbody>
								</table>
				...
				<div class="">
					<paginator:page name="paginator" form="queryform"
									action="/review/onLoanReview/list" />
				</div>
				<!-- 分页标签结束 -->
