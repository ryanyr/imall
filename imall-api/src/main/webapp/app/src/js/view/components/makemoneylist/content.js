        ...
        return (
            <div className="list_con">
                ...
                <div className="list_info">
                    <div>
                        <span>所有权：</span>
                        <span><label><input type="radio" name="ti1" defaultChecked={this.state.ti1==1?"true":""} onChange={()=>{
                            this.setState({
                                ti1:1
                            })
                        }}/>自持</label></span>
                        <span><label><input type="radio"  name="ti1" defaultChecked={this.state.ti1==2?"true":""} onChange={()=>{
                            this.setState({
                                ti1:0
                            })
                        }}/>租赁</label></span>
                    ...
                    <div>
                        <span>按揭情况：</span>
                        <span><label><input type="radio" name="ti2" defaultChecked={this.state.ti2==1?"true":""} onChange={()=>{
                            this.setState({
                                ti2:1
                            })
                        }}/>全款</label></span>
                        <span><label><input type="radio" name="ti2" defaultChecked={this.state.ti2==2?"true":""} onChange={()=>{
                            this.setState({
                                ti2:0
                            })
                        }}/>按揭</label></span>
                ...
                <div className="list_info">
                    <div>
                        <span>按揭情况：</span>
                        <span><label><input type="radio" name="ti4" defaultChecked={this.state.ti4==1?"true":""} onChange={()=>{
                            this.setState({
                                ti4:1
                            })
                        }}/>全款</label></span>
                        <span><label><input type="radio" name="ti4" defaultChecked={this.state.ti4==2?"true":""} onChange={()=>{
                            this.setState({
                                ti4:0
                            })
                        }}/>按揭</label></span>
